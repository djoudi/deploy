server {
	...
	server_name homewardboundsouthswsuburbs.com;

	## Log Settings.
	access_log   /var/log/nginx/homewardboundsouthswsuburbs.com.access.log;
	error_log    /var/log/nginx/homewardboundsouthswsuburbs.com.error.log;
	
	root /home/masedi/tagzones/homewardboundsouthswsuburbs.com;
	...
	include /home/masedi/tagzones/homewardboundsouthswsuburbs.com/.ngaccess;
...
# Redirect database access to www
server {
        listen          80;
        server_name     www.homewardboundsouthswsuburbs.com;
        return          301 http://homewardboundsouthswsuburbs.com$request_uri;
}
