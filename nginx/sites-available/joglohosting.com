server {
	...
	server_name joglohosting.com www.joglohosting.com direct.joglohosting.com;

	## Log Settings.
	access_log   /var/log/nginx/joglohosting.com.access.log;
	error_log    /var/log/nginx/joglohosting.com.error.log;
	
	root /home/masedi/joglohosting.com;
	...
	# Better WP Security
	#include /etc/nginx/conf.vhost/better-wp-security.conf;	
	include /home/masedi/joglohosting.com/.ngaccess;
...
server {
	listen		80;
	server_name	db.joglohosting.com;
