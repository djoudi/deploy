server {
	...
	server_name babyspielzeug.quietrm.com;

	## Log Settings.
	access_log   /var/log/nginx/babyspielzeug.quietrm.com.access.log;
	error_log    /var/log/nginx/babyspielzeug.quietrm.com.error.log;
	
	root /home/masedi/tagzones/babyspielzeug;
	...
	include /home/masedi/tagzones/babyspielzeug/.ngaccess;
