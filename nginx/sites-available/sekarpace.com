server {
	...
	server_name sekarpace.com www.sekarpace.com direct.sekarpace.com;

	## Log Settings.
	access_log   /var/log/nginx/sekarpace.com.access.log;
	error_log    /var/log/nginx/sekarpace.com.error.log;
	
	root /home/kudo/sekarpace.com;
	...
	location ~ \.php$ {
		...
		fastcgi_pass unix:/var/run/php5-fpm.kudo.sock;
